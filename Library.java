...
class Library {
  ...
  //@ ensures   \old(holdings.size()) == holdings.size() + 1;
  ...
  //@ ensures \result == true  ==>  \old(holdings.size()) == holdings.size()-1;
  ...
  //@ ensures \forall int i ; i < holdings.size(); \old( holdings.get(i)) == holdings.get(i);
  //increasing i;
